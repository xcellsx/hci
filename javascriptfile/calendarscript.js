document.addEventListener("DOMContentLoaded", function() {
    ...
    daysContainer.addEventListener("click", function(event) {
        if (event.target.nodeName === "DIV" && event.target.textContent.trim() !== '') {
            ...
            expenditureSection.classList.add("show"); // Show the card when a date is clicked
        }
    });
    ...
    function renderCalendar() {
        ...
        // Hide expenditure content card by default
        const expenditureSection = document.getElementById("expenditureData");
        expenditureSection.classList.remove("show");
    }
