document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderGoal(goal) {
        ...
        editButton.addEventListener("click", () => {
            ...
            document.getElementById("goals-container").appendChild(newGoalCard);
        });

        // Add click event listener to navigate to edit-goal.html
        if (goal.name === "Hostel") {
            eyeButton.addEventListener("click", () => {
                const editUrl = `edit-goals.html?name=${encodeURIComponent(goal.name)}&amount=${goal.amount}&current=${goal.current}`;
        ...
        deleteButton.addEventListener("click", () => {
            ...
            // Example: confirm deletion and remove the goal card
            newGoalCard.remove(); // Remove the card from UI
            const goals = loadGoals();
            // Assuming goal.name is unique for identification
